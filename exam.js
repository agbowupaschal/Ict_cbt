const questions = [
	...
	{
		question:
			"Software reinstallation is effective when: (I) When application files are damaged, (II) Registry entries are corrupted, (III) Recently installed drivers, (IV) Configuration files are improperly modified",
